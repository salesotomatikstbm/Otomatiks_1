        ...
        <section className="text py-16">
            <div className="container mx-auto px-6 lg:px-12 text-center">
                ...
                <div className="grid gap-8 lg:grid-cols-3 mt-8">
                    {/* Email Contact */}
                    <div className="flex flex-col items-center p-6 border border-gray-600 rounded-lg  transition-colors duration-300">
                    ...
                    {/* Phone Contact */}
                    <div className="flex flex-col items-center p-6 border border-secondary rounded-lg  transition-colors duration-300">
