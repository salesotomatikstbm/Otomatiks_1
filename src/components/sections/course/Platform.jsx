...
import videoFile from "../../../assets/images/services/about2.mp4"; // Add your local video path here
        ...
        <div className="lg:grid grid-cols-12 gap-[30px]">
          <div className="xl:col-span-5 lg:col-span-6 col-span-12">
            ...
            <Title size={"3.5xl"} className={"pb-5"}>
              Explore the World of Robotics & Coding from Home
            </Title>
            <SectionDescription className={""}>
              Dive into robotics education with our comprehensive online
              classes. Designed for students of all ages, our courses make
              learning about robotics engaging and accessible.
            </SectionDescription>
            <SectionDescription>
              Join a community of learners, connect with instructors in
              real-time, and gain practical skills that prepare you for a
              future in STEM.
            </SectionDescription>
