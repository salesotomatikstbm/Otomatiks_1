        ...
        <section className="lg:pt-15 lg:pb-15 pt-10 pb-10 relative">
            <div className="container">
                <div className="flex flex-col justify-center items-center">
                    <SectionName className={"text-primary-foreground"}>School Program</SectionName>
                    <Title size={"3.5xl"} className={"mt-2.5 text-center max-w-[514px]"}>Lorem ipsum dolor sit amet consectetur</Title>
                </div>
