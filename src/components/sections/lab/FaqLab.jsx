...
import { faqData } from '@/lib/fackdata/faqLab'
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-7.5">
          ...
          <div>
            <div className=" pb-10">
              ...
              <Title size={"3.5xl"} className={"text-white"}>Everything You Need to Know About the Robotics & AI Lab Program</Title>
            </div>
