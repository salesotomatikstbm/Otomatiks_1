...
const Testimonial = () => {
    return (
        <section className="lg:pt-15 lg:pb-15 pt-10 pb-10 testimonial relative bg-[#066aab]">
            <div className="container relative z-10">
                ...
                <div className="relative w-full h-full lg:after:absolute lg:after:left-0 lg:after:top-0 lg:after:max-w-[calc(100%-410px)] lg:after:max-w-[calc(100%-310px)] lg:after:max-w-[calc(100%-100px)] lg:after:w-full lg:after:h-full lg:after:bg-testimonial-banner lg:after:bg-cover lg:after:bg-no-repeat lg:after:z-[-1]">
                    {/* Background Image */}
                    <div className="block lg:hidden w-full h-48 bg-testimonial-banner bg-cover bg-no-repeat absolute top-0 left-0 z-0"></div>
...
const Card = ({ name, src, position, review, rating }) => {
    return (
        <div className="lg:p-10 sm:p-4 py-8 sm:py-0 sm:-mr-10 ">
            <div className="mb-12 bg-background border border-[#F2F2F2] lg:p-15 md:p-5 p-3 max-w-[630px] w-full rounded-[10px] ml-auto shadow-[0px_0px_60px_0px_rgba(0,0,0,0.05)]">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center relative z-10 lg:pb-7.5 pb-5 gap-4 sm:gap-5">
                    ...
                    <div className="flex items-center gap-5 sm:gap-10">
                        <img src={src} alt="bg-img" className="w-full sm:w-auto hidden sm:block" />
                        <div>
